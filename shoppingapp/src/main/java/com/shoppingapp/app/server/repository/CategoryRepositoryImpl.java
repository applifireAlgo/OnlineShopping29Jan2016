...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for Category Master table Entity", complexity = Complexity.LOW)
public class CategoryRepositoryImpl extends SearchInterfaceImpl implements CategoryRepository<Category> {
    ...
    public List<Category> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.shoppingapp.app.shared.onlineshopping.Category> query = emanager.createQuery("select u from Category u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Category> save(List<Category> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.shoppingapp.app.shared.onlineshopping.Category obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.shoppingapp.app.shared.onlineshopping.Category s = emanager.find(com.shoppingapp.app.shared.onlineshopping.Category.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Category> findByProductId(String productId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.shoppingapp.app.shared.onlineshopping.Category> listOfCategory = query.getResultList();
    ...
    public Category findById(String categoryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.shoppingapp.app.shared.onlineshopping.Category listOfCategory = (com.shoppingapp.app.shared.onlineshopping.Category) query.getSingleResult();
            return listOfCategory;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
