...
import com.shoppingapp.app.server.businessservice.OrderMainBusinessService;
...
public class OrderMainServiceImpl extends OrderMainService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.shoppingapp.app.shared.onlineshopping.OrderMain> lstordermain = orderMainrepo.findAll();
    ...
    private Map<String, String> getFieldMetaData() {
        ...
        fieldMetaData.put("orderDate", "DATE");
    ...
    public HttpEntity<ResponseBean> findByUserId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.shoppingapp.app.shared.onlineshopping.OrderMain> lstordermain = orderMainrepo.findByUserId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstordermain);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.shoppingapp.app.shared.onlineshopping.OrderMain lstordermain = orderMainrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstordermain);
        } catch (org.springframework.transaction.TransactionException e) {
