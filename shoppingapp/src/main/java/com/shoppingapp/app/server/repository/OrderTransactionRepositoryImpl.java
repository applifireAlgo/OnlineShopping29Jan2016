...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for OrderTransaction Master table Entity", complexity = Complexity.LOW)
public class OrderTransactionRepositoryImpl extends SearchInterfaceImpl implements OrderTransactionRepository<OrderTransaction> {
    ...
    public List<OrderTransaction> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.shoppingapp.app.shared.onlineshopping.OrderTransaction> query = emanager.createQuery("select u from OrderTransaction u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<OrderTransaction> save(List<OrderTransaction> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.shoppingapp.app.shared.onlineshopping.OrderTransaction obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.shoppingapp.app.shared.onlineshopping.OrderTransaction s = emanager.find(com.shoppingapp.app.shared.onlineshopping.OrderTransaction.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<OrderTransaction> findByOrderId(String orderId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.shoppingapp.app.shared.onlineshopping.OrderTransaction> listOfOrderTransaction = query.getResultList();
    ...
    public OrderTransaction findById(String orderTransactionId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.shoppingapp.app.shared.onlineshopping.OrderTransaction listOfOrderTransaction = (com.shoppingapp.app.shared.onlineshopping.OrderTransaction) query.getSingleResult();
            return listOfOrderTransaction;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
