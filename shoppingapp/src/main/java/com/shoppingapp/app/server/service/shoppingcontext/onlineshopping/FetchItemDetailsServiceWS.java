package com.shoppingapp.app.server.service.shoppingcontext.onlineshopping;
import com.athena.framework.server.bean.ResponseBean;
import com.athena.framework.server.exception.biz.SpartanBusinessValidationFailedException;
import com.athena.framework.server.exception.biz.SpartanDataNotFoundException;
import com.athena.framework.server.exception.biz.SpartanIncorrectDataException;
import com.athena.framework.server.exception.repository.SpartanPersistenceException;
import com.shoppingapp.app.server.businessservice.shoppingcontext.onlineshopping.FetchItemDetailsService;
...
public class FetchItemDetailsServiceWS {
    ...
    public HttpEntity<ResponseBean> fetchItemDetails() throws Exception, SpartanBusinessValidationFailedException, SpartanDataNotFoundException, SpartanIncorrectDataException, SpartanPersistenceException {
        ...
        java.util.List<com.shoppingapp.app.shared.shoppingcontext.FetchItemDetails> _ruleOutput = fetchitemdetailsservice.fetchItemDetails();
