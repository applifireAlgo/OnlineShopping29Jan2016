...
public class ItemRepositoryImpl extends SearchInterfaceImpl implements ItemRepository<Item> {
    ...
    public List<Item> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.shoppingapp.app.shared.onlineshopping.Item> query = emanager.createQuery("select u from Item u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Item> save(List<Item> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.shoppingapp.app.shared.onlineshopping.Item obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.shoppingapp.app.shared.onlineshopping.Item s = emanager.find(com.shoppingapp.app.shared.onlineshopping.Item.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Item> findByProductId(String productId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.shoppingapp.app.shared.onlineshopping.Item> listOfItem = query.getResultList();
            return listOfItem;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Item findById(String itemId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.shoppingapp.app.shared.onlineshopping.Item listOfItem = (com.shoppingapp.app.shared.onlineshopping.Item) query.getSingleResult();
            return listOfItem;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
