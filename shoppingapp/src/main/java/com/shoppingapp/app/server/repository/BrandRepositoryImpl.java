...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Repository for Brand Master table Entity", complexity = Complexity.LOW)
public class BrandRepositoryImpl extends SearchInterfaceImpl implements BrandRepository<Brand> {
    ...
    public List<Brand> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.shoppingapp.app.shared.onlineshopping.Brand> query = emanager.createQuery("select u from Brand u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Brand> save(List<Brand> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.shoppingapp.app.shared.onlineshopping.Brand obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.shoppingapp.app.shared.onlineshopping.Brand s = emanager.find(com.shoppingapp.app.shared.onlineshopping.Brand.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Brand> findByProductId(String productId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.shoppingapp.app.shared.onlineshopping.Brand> listOfBrand = query.getResultList();
            return listOfBrand;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Brand findById(String brandId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.shoppingapp.app.shared.onlineshopping.Brand listOfBrand = (com.shoppingapp.app.shared.onlineshopping.Brand) query.getSingleResult();
            return listOfBrand;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
