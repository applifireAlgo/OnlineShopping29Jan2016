...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Cart", complexity = Complexity.LOW)
...
public class Cart implements Serializable, CommonEntityInterface, Comparator<Cart> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shoppingapp.app.shared.onlineshopping.Cart other = (com.shoppingapp.app.shared.onlineshopping.Cart) obj;
            if (cartId == null) {
                return false;
