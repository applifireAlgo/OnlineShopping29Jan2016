package com.shoppingapp.app.shared.location;
...
public class AddressExtended implements Serializable, CommonEntityInterface, Comparator<AddressExtended> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shoppingapp.app.shared.location.AddressExtended other = (com.shoppingapp.app.shared.location.AddressExtended) obj;
            if (addExtId == null) {
                return false;
