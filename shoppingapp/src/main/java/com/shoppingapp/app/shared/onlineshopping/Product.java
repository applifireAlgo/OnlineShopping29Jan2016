...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Product", complexity = Complexity.LOW)
...
public class Product implements Serializable, CommonEntityInterface, Comparator<Product> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shoppingapp.app.shared.onlineshopping.Product other = (com.shoppingapp.app.shared.onlineshopping.Product) obj;
            if (productId == null) {
                return false;
