package com.shoppingapp.app.shared.authentication;
...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    public User addPassRecovery(PassRecovery _passRecovery) {
        if (this.passRecovery == null) {
            this.passRecovery = new java.util.ArrayList<com.shoppingapp.app.shared.authentication.PassRecovery>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            com.shoppingapp.app.shared.authentication.User other = (com.shoppingapp.app.shared.authentication.User) obj;
            if (userId == null) {
                return false;
