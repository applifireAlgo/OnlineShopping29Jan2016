...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "OrderDetails", complexity = Complexity.LOW)
public class OrderDetails implements Serializable, CommonEntityInterface, Comparator<OrderDetails> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shoppingapp.app.shared.onlineshopping.OrderDetails other = (com.shoppingapp.app.shared.onlineshopping.OrderDetails) obj;
            if (orderItemId == null) {
                return false;
