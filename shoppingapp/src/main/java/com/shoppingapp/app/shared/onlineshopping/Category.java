...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "", versionNumber = "1", comments = "Category", complexity = Complexity.LOW)
...
public class Category implements Serializable, CommonEntityInterface, Comparator<Category> {
    ...
    public boolean equals(Object obj) {
        try {
            com.shoppingapp.app.shared.onlineshopping.Category other = (com.shoppingapp.app.shared.onlineshopping.Category) obj;
            if (categoryId == null) {
                return false;
