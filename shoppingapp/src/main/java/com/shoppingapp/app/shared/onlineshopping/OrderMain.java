package com.shoppingapp.app.shared.onlineshopping;
...
import com.shoppingapp.app.shared.EntityAudit;
import javax.persistence.Embedded;
import com.shoppingapp.app.shared.SystemInfo;
...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "4", comments = "OrderMain", complexity = Complexity.LOW)
...
public class OrderMain implements Serializable, CommonEntityInterface, Comparator<OrderMain> {
    ...
    public OrderMain addOrderDetails(OrderDetails _orderDetails) {
        if (this.orderDetails == null) {
            this.orderDetails = new java.util.ArrayList<com.shoppingapp.app.shared.onlineshopping.OrderDetails>();
        }
    ...
    @JsonIgnore
    public Integer sizeOfOrderDetails() {
        if (this.orderDetails != null) {
    ...
    public boolean equals(Object obj) {
        try {
            com.shoppingapp.app.shared.onlineshopping.OrderMain other = (com.shoppingapp.app.shared.onlineshopping.OrderMain) obj;
            if (orderId == null) {
                return false;
