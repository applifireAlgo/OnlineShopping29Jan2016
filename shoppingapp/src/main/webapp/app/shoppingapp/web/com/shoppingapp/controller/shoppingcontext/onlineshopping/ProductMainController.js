Ext.define('Shoppingapp.shoppingapp.web.com.shoppingapp.controller.shoppingcontext.onlineshopping.ProductMainController', {
     ...
     hideDataBrowser: function() {
          var form = this.view.down('#Product');
          var grid = this.view.down('#ProductGrid');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               ...
               var formPanel = this.getView().up().down("#Product");
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#Product').down('#' + me.column.dataIndex + '').store;
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.productId;
          me = this;
     ...
     loadData: function(responseData) {
          this.view.down('#Product').getViewModel().setData(responseData.response.data);
     },
