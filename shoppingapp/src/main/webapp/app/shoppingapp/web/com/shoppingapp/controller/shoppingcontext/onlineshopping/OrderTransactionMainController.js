Ext.define('Shoppingapp.shoppingapp.web.com.shoppingapp.controller.shoppingcontext.onlineshopping.OrderTransactionMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.orderTransactionId;
          me = this;
     ...
     saveForm: function(but, evt) {
          ...
          var method;
          if (jsonData.orderTransactionId == null) {
               method = 'POST'
          } else {
               method = 'PUT';
               jsonData.systemInfo = {
