Ext.define('Shoppingapp.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Shoppingapp.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Shoppingapp.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Shoppingapp.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Shoppingapp.view.querybuildernewmodel.querydetail.QueryDetail');
