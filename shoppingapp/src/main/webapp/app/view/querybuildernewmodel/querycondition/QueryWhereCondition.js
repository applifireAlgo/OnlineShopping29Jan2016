Ext.define('Shoppingapp.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Shoppingapp.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
