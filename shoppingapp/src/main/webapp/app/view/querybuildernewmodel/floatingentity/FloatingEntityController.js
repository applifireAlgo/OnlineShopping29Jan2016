Ext.define('Shoppingapp.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Shoppingapp.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Shoppingapp.view.querybuildernewmodel.queryentitiesjoins.Query',
