Ext.define('Shoppingapp.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Shoppingapp.view.reportui.datachart.chart.RatingField','Shoppingapp.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
