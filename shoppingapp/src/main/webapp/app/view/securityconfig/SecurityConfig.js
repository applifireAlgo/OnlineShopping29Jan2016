 ...
 * 
 */
Ext.define('Shoppingapp.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Shoppingapp.view.securityconfig.SecurityConfigController',
			'Shoppingapp.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
