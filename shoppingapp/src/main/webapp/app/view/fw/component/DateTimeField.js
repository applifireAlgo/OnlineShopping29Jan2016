 ...
 */
Ext.define('Shoppingapp.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Shoppingapp.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Shoppingapp.view.fw.component.DateTimePicker(o);
    },
