 ...
 * 
 */
Ext.define("Shoppingapp.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Shoppingapp.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
