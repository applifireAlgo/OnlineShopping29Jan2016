Ext.define('Shoppingapp.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Shoppingapp.view.reportbuilder.reportlist.ReportListPanelView',
             'Shoppingapp.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Shoppingapp.view.reportbuilder.mainview.ReportMainController'
             ],
