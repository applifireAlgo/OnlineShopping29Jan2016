Ext.define('Shoppingapp.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Shoppingapp.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Shoppingapp.view.reportbuilder.gridconfig.GridConfigView',
	           'Shoppingapp.view.reportbuilder.properties.PropertiesPanelView',
	           'Shoppingapp.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
