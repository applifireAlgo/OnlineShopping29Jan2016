Ext.define('Shoppingapp.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Shoppingapp.view.reportbuilder.properties.RptDataEndPointGridController'],
