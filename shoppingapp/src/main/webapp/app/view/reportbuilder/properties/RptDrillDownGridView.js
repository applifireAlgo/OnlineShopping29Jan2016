Ext.define('Shoppingapp.view.reportbuilder.properties.RptDrillDownGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Shoppingapp.view.reportbuilder.properties.RptDrillDownGridController'],
