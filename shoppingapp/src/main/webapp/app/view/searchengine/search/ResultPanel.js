Ext
		.define(
				'Shoppingapp.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Shoppingapp.view.searchengine.search.SearchEngineMainPanelController','Shoppingapp.view.searchengine.search.PanelHeaderField' ,'Shoppingapp.view.searchengine.search.ReportGridView','Shoppingapp.view.searchengine.search.ReportChartView','Shoppingapp.view.searchengine.search.documentView','Shoppingapp.view.searchengine.search.DouMeanView','Shoppingapp.view.googlemaps.map.MapPanel'],
