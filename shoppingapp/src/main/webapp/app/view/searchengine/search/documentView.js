Ext
		.define(
				'Shoppingapp.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Shoppingapp.view.searchengine.search.documentController',
							'Shoppingapp.view.searchengine.search.RowExpander' ],
