Ext.define('Shoppingapp.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Shoppingapp.view.searchengine.search.NorthPanel', 'Shoppingapp.view.searchengine.search.SearchResult','Shoppingapp.view.searchengine.search.SearchEngineMainPanelController'],
