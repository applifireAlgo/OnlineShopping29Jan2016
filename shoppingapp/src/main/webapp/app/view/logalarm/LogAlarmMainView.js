 ...
 * 
 */
Ext.define('Shoppingapp.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Shoppingapp.view.logalarm.LogAlarmMainViewController',
			'Shoppingapp.view.logalarm.tree.LogAlarmTreePanel',
			'Shoppingapp.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
