 ...
 * 
 */
Ext.define('Shoppingapp.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Shoppingapp.view.logalarm.mainscreen.AddLogAlarmController',
			'Shoppingapp.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Shoppingapp.view.logalarm.mainscreen.AppAlarmPanel',
