 ...
 * 
 */
Ext.define('Shoppingapp.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Shoppingapp.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
