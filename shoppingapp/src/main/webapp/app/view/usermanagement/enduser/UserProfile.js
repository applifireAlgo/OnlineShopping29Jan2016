Ext.define('Shoppingapp.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Shoppingapp.view.usermanagement.enduser.UserProfileController', 'Shoppingapp.view.usermanagement.admin.AddUserDetailsViewModel', 'Shoppingapp.model.AddUserDataModel' ],
