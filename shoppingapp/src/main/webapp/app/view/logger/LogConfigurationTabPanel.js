...
Ext
		.define(
				'Shoppingapp.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Shoppingapp.view.logger.tabs.details.DetailsTab',
							'Shoppingapp.view.logger.tabs.fileconnector.FileConnectorTab',
							'Shoppingapp.view.logger.tabs.dbconnector.DBConnectorTab',
							'Shoppingapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Shoppingapp.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Shoppingapp.view.logger.LogConfigurationTabPanelController',
