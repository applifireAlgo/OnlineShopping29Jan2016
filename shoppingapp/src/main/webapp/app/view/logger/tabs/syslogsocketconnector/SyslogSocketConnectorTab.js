 ...
 * 
 */
Ext.define('Shoppingapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Shoppingapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
