...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("daRwQIth3HkcyZpmN4mz3ukgabgHndDL");
            country.setCapitalLatitude(8);
            country.setCapitalLongitude(10);
            country.setCountryCode1("wfp");
            country.setCountryCode2("lwo");
            country.setCountryFlag("0ppMszTFLRu0I08UHyLo9GXhbPc5OKxngNnrTJJUM3SovLMzuj");
            country.setCountryName("gLL1tJ6mVcv8WvMNu8KP0JeO5rGTOcffnp2LBuveNhVt0TD1GJ");
            country.setCurrencyCode("1NZ");
            country.setCurrencyName("r5YTRW6ioqlwR4c7WuNKcmNcDJ6L4B7G066XrKr5gVNrL79BVa");
            country.setCurrencySymbol("igsfviEotuILQKEV2B3hVLKIeBrk8jIm");
            country.setIsoNumeric(0);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("c4nfqB8G6bi0B6wC45lpW3MNSgJRADlfhPf7wmip5gz10qH2cw");
            currency.setUnicodeDecimal("F3KwVsdyLhCqQw9Bo4YPpOF3M5xrM6u2DCOy5GAgx96NyPVy1S");
            currency.setUnicodeHex("HIQvqTR4vqvYKTdbLtlHAC7ese0BmqNc9CQae2ethqT9RRpD35");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("HfzqFf3svyMDynwXArECfL2pmRz71bVMIhBhnT4tykFYWqbbtj");
            currency.setUnicodeDecimal("HgjrGy1PavljaCANftAOn6b0LQMEnQtw1qhgzI4tS3B0ox2MVM");
            currency.setUnicodeHex("YPrSqAleT7iwa1CNHMEzQSmcXj5ffky9wNN24NGaPexrVNr5sa");
